              ...
              <div className="p-6">
                <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between space-y-4 lg:space-y-0">
                  ...
                  <div className="flex flex-col space-y-2 lg:ml-6">
                    ...
                    {workOrder.completion_approved_at && (
                        ...
                        {workOrder.signed_document ? (
                          <>
                            ...
                            <label className="cursor-pointer inline-block w-full lg:w-auto">
                              <input
                                ...
                                onChange={async (e) => {
                                  ...
                                  try {
                                    ...
                                    const response = await fetch(`/api/work-orders/${workOrder.id}/signed-document`, {
                                      method: 'POST',
                                      headers,
                                      body: formData
                                    });
                              ...
                              />
                              <span className="inline-flex items-center justify-center font-medium rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 px-3 py-1.5 text-sm border-2 border-[#08398F] text-[#08398F] hover:bg-[#08398F] hover:text-white focus:ring-[#08398F] w-full lg:w-auto justify-center">
                                🔄 Replace PDF
                              </span>
                            </label>
                              ...
                              <Button
                                ...
                                onClick={async () => {
                                  if (confirm('Are you sure you want to delete this signed document? This action cannot be undone.')) {
                                    try {
                                      const response = await apiClient.delete(`/work-orders/${workOrder.id}/signed-document`);
                                      if (response.success) {
                                        fetchWorkOrders();
                                ...
                                className="flex items-center space-x-2 w-full lg:w-auto justify-center text-red-600 hover:text-red-700"
                              >
                                <span>🗑️</span>
                          ...
                          <label className="cursor-pointer inline-block w-full lg:w-auto">
                            ...
                            />
                            <span className="inline-flex items-center justify-center font-medium rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 px-3 py-1.5 text-sm bg-[#08398F] text-white hover:bg-[#062a6b] focus:ring-[#08398F] w-full lg:w-auto justify-center">
                              📤 Upload PDF
                            </span>
                          </label>
                        )}
